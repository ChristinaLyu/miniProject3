...
+1 for using more than one data layer from the macleish package in your analysis (e.g. both vegetation and elevation data)
...
In this project we are trying to be able to make classifications of the trails based on their length and change in elevation. We would also try to make one function that would simplify the process of classification.
...
```{r}
leaflet() %>%
  addPolygons(data = st_geometry(elevation))
